...
public class SimilarityTest {
        ...
        JavaRDD<TfIdfData> newsInfoRDD = spark.read().textFile(dataPath).javaRDD().map(new Function<String, TfIdfData>() {
            ...
            private void initSegment() throws Exception {
                if (seg == null) {
                    ...
                    String path = "/Users/wulinhao/Downloads/BigDataPlatform/compute-realtime/compute-realtime-spark/src/main/java/com/platform/spark/spark/similar";
    ...
    public static void run() throws Exception{
        initSpark();
        String dataPath = "/Users/wulinhao/Downloads/BigDataPlatform/compute-realtime/compute-realtime-spark/src/main/java/com/platform/spark/spark/similar/input.txt";

        Dataset<Row> dataSet = readTxt(dataPath);
        dataSet.show();
        Dataset<Row> tfidfDataSet = tfidf(dataSet);
        String id = "1";
        String similarFile = "/Users/wulinhao/Downloads/BigDataPlatform/compute-realtime/compute-realtime-spark/src/main/java/com/platform/spark/spark/similar/output.txt";
